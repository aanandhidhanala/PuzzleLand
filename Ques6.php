...
<?php  if (isset($_SESSION['username'])) : ?>
  <nav class="navbar">
    ...
    <div class="container">
    <p class="head">Solve the Sudoku puzzle provided below and enter the numbers that correspond to the colored boxes in the order of the rainbow colors, starting with violet.</p>
    <img src="sudoku.png" alt="">
