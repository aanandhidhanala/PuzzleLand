...
<?php  if (isset($_SESSION['username'])) : ?>
  <nav class="navbar">
    ...
    <div class="container">
    <p class="head">In which year Apple Computer Inc, was founded......??
<br><br>
<b>Example:</b>If the answer is 30 May,2003 then answer should be written in this format "30052003" 
    </p>
